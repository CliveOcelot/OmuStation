//using Content.Shared._RMC14.Armor; // Omu, we don't have this
using Content.Shared._RMC14.Barricade.Components;
using Content.Shared._RMC14.Construction.Upgrades;
//using Content.Shared._RMC14.Xenonids.Leap; // Omu, we don't have this
//using Content.Shared._RMC14.Xenonids.Acid; // Omu, we don't have this
...
public abstract class SharedBarbedSystem : EntitySystem
{
    ...
    //[Dependency] private readonly SharedXenoAcidSystem _xenoAcid = default!; // Omu, we don't have this
    ...
    public override void Initialize()
    {
        ...
        //SubscribeLocalEvent<BarbedComponent, CMGetArmorPiercingEvent>(OnGetArmorPiercing); // Omu, we don't have this
        SubscribeLocalEvent<BarbedComponent, RMCConstructionUpgradedEvent>(OnConstructionUpgraded);
        //SubscribeLocalEvent<BarbedComponent, XenoLeapHitAttempt>(OnXenoLeapHitAttempt, after: new[] { typeof(XenoLeapSystem) }); // Omu, we don't have this
    }
